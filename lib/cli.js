...
cli.up = function(options) {
  ...
  return _push(options.remote, options.branch, options.draft, options.topic, options.hashtag)
    .then(function() {
...
function _push(remote, branch, is_draft, topic, hashtag) {
  ...
  return gerrit.parseRemote(remote)
    ...
    .then(function(patch) {
      ...
      .then(function() {
        ...
        return gerrit.up(remote, branch, is_draft, topic, hashtag);
